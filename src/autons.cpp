...
void default_constants() {
  ...
  chassis.pid_turn_constants_set(0.75, 0.0, 0.0, 15.0);     // Turn in place constants
  chassis.pid_swing_constants_set(6.0, 0.0, 65.0);           // Swing constants
  chassis.pid_odom_angular_constants_set(3.25, 0.0, 52.5);    // Angular control for odom motions
...
void testaut() {
  ...
  chassis.pid_odom_set({{24_in, -36_in}, rev, 55});
  chassis.pid_wait();
  mogo_clamp.set(true);
